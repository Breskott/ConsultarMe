...
gj.picker.methods = {
    ...
    initialize: function ($input, data, methods) {
        ...
        if (data.uiLibrary === 'bootstrap') {
            ...
            $rightIcon = $('<span class="input-group-append"><button class="btn btn-primary" style="padding: 20px 20px; margin-left: 8px;" type="button">' + data.icons.rightIcon + '</button></span>');
        } else {
