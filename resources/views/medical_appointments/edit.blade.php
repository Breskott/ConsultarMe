    ...
    <section class="breadcrumbs">
        <div class="container">
            <ol>
                ...
                <li><a href="{{ route('exams.index') }}">Editar Consulta</a></li>
            </ol>
    ...
    <section class="inner-page forms-site">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card mb-4">
                        <form action="{{ route('medical_appointments.update', $medical_appointments->id) }}" method="post"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control m-b" name="tab_central_vacancy">
                                                <option value="Y"
                                                        @if(old('tab_central_vacancy', $medical_appointments->tab_central_vacancy) == 'Y') selected @endif>{{ __('Sim') }}</option>
                                                <option value="N"
                                                        @if(old('tab_central_vacancy', $medical_appointments->tab_central_vacancy) == 'N') selected @endif>{{ __('Não') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="comments" id="comments" rows="3" style="margin-top: 0px; margin-bottom: 0px; height: 115px;">{{ old('comments', $medical_appointments->comments) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    @if(!empty($medical_appointments->files))
                                        <label class="form-control-label">{{ __('Clique para baixar os arquivos enviado anteriormente') }}</label>
